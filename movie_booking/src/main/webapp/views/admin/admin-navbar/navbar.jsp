...
<nav class="w-1/7 p-1">
    <ul>
        <li class="mb-4">
            <a href="${pageContext.request.contextPath}/admin/movie-management?action=showMovies" class="nav-link block py-4 px-7 bg-gray-200 colorButton" align="center">Movies</a>
        </li>
        <li class="mb-4">
