...
<div class="container">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            radios.forEach(radio => {
                radio.addEventListener('change', function() {
                    ...
                    document.getElementById('totalSelections').textContent = totalSelected;
                });
            });
        });
    </script>
    ...
    <form class="feedback-form" action="SubmitFeedbackServlet" method="post">
        ...
        <div class="question-group">
            ...
            <div class="rating">
                <input type="radio" name="ticketEase" value="1" >
                <input type="radio" name="ticketEase" value="2">
                <input type="radio" name="ticketEase" value="3">
                <input type="radio" name="ticketEase" value="4">
                <input type="radio" name="ticketEase" value="5">
            </div>
        </div>
        ...
        <div class="question-group">
            ...
            <div class="rating">
                ...
                <input type="radio" name="payments" value="3">
                <input type="radio" name="payments" value="4">
                <input type="radio" name="payments" value="5">
            </div>
        </div>
